...
The directory tree visualization will automatically show your changes: - New files appear as green leaf nodes (📄) - New directories appear as blue folder nodes (📁) - Descriptions show on hover
